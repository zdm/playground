        ...
        "anyOf": [
            ...
            },
            {
                ...
                "properties": {
                    ...
                    "telegram_webapp_init_data": {
                        "type": "string"
                    }
                },
                "additionalProperties": false,
                "required": ["telegram_bot_id", "telegram_webapp_init_data"]
            }
        ]
    }
    ```
...
-   `options` <Object\>
    ...
    -   `where` <Object\> Set of the filters by field values:
        ...
        -   `subscribed` <Array\> Filter by the `subscribed` field value:
            -   <string\> Filter operator, one of the: `"="`.
            -   <boolean\> Field value.
        -   `banned` <Array\> Filter by the `banned` field value:
            -   <string\> Filter operator, one of the: `"="`.
            -   <boolean\> Field value.
...
<!-- prettier-ignore -->
```javascript
const res = await api.call( "/v1/telegram/bots/users/set-user-banned", teleram_bot_id, teleram_bot_user_id, banned );
```
...
curl \
    -H "Authorization: Bearer <YOUR-API-TOKEN>" \
    "https://localhost/api/v1/telegram/bots/users/set-user-banned"
```
