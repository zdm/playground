...
export default class extends App {
    ...
    async _start () {
        ...
        // res = await this.telegram.bots.getBot( 1 ).files.createFile( {
        ...
        // res = await this.telegram.bots.getBot( 1 ).files.getFile( "BQACAgIAAxkBAAIFp2UdnrxoXd_Z6u8NcO6gcB_8Nq1jAAKdOwACn-TxSLBmHg8FX1lKMAQ" );

        // // res = await this.telegram.bots.getBot( 1 ).files.getFile( 1 );
        // console.log( res );

        // XXX nfinx sockets issue
