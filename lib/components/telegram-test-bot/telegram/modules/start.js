import LocaleTranslation from "#core/locale/translation";
    ...
    class extends Super {
        ...
        async #setChatCommands ( ctx ) {
            return ctx.user.setChatCommands( [
                ...
                {
                    "command": "test",
                    "description": this.l10nt( "Test" ),
                },
                {
                    "command": "back",
                    "description": this.l10nt( "<- back" ),
                },
            ] );
        }
            ...
            return ctx.user.send( "sendMessage", {
                ...
                "reply_markup": {
                    ...
                    "keyboard": [
                        [
                            {
                                "text": this._createAction( this.l10nt( "some action" ) ),
                            },
                        ],
                        [
                            {
